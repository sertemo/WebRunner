...
class BrowserFactory:
    ...
    def _prepare_chrome_options(self, proxy: str | None, user_agent: str | None) -> ChromeOptions:
    ...
    def _prepare_firefox_options(self, proxy: str | None, user_agent: str | None) -> FirefoxOptions:
    ...
    def create_browser(self, proxy: str | None, user_agent: str | None) -> Chrome | Firefox:
